...
export const postUser = async (req, res) => {
    ...
    //getting salt and then applying it to the password.
    const salt = getSalt();
    ...
    try {
        ...
        const query = {
            ...
            values: [username, first_name, last_name, birthdate, saltedHash, email, points || 0], // Default points to 0 if not provided
        };
